...
class Transaksi extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'Transaksi');
		$this->CacheExp = 3600; # in seconds (1 hour)

		/* Table Setup */
		$this->setTable('data__transaksi')
			->setColumns([
			'id', 
			'iduser', 
			'foto', 
	...
	/**
	 * Get Data in Transaksi by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Remove single or multiple data from Transaksi
	 *
