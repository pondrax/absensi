...
class Bidang extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'Bidang');
		$this->CacheExp = 3600; # in seconds (1 hour)

		/* Table Setup */
		$this->setTable('master__bidang')
			->setColumns([
			'id', 
			'idperusahaan', 
			'bidang'
	...
	/**
	 * Get Data in Bidang by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Remove single or multiple data from Bidang
	 *
