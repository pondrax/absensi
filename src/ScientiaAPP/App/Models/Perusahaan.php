...
* @copyright  (c) 2020 benedict.erwin@gmail.com
...
class Perusahaan extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'Perusahaan');
		$this->CacheExp = 3600; # in seconds (1 hour)

		/* Table Setup */
		$this->setTable('master__perusahaan')
			->setColumns([
			'id', 
			'perusahaan', 
			'logo'
	...
	/**
	 * Get Data in Perusahaan by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Remove single or multiple data from Perusahaan
	 *
