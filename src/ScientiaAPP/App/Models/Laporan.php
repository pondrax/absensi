...
class Laporan extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'Laporan');
		$this->CacheExp = 3600; # in seconds (1 hour)

		/* Table Setup */
		$this->setTable('view__transaksi')
			->setColumns([
			'iduser', 
			'tanggal', 
			'masuk', 
	...
	/**
	 * Get Data in Laporan by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Remove single or multiple data from Laporan
	 *
