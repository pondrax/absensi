...
class Laporan extends \App\Controllers\PrivateController
{
	/* Declare Model */
	private $MODEL;
	...
	public function __construct(\Slim\Container $container)
	{
		...
		/* Set Model */
		$this->MODEL = new \App\Models\Laporan($container);
	}
	...
	public function create()
	{
		...
		$gump->filter_rules([
			"fotoMasuk" => "trim|sanitize_string",
			"fotoKeluar" => "trim|sanitize_string",
			"nama" => "trim|sanitize_string",
			"perusahaan" => "trim|sanitize_string",
			"bidang" => "trim|sanitize_string"
		]);
